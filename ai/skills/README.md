...
| Pre-merge E2E verification + Slack reporting | `e2e-release-verification.md` | `qa-testing.md` |
...
| `e2e-release-verification.md` | Pre-merge battery: QA + security + Playwright E2E (video/screenshots) + Slack delivery; opt-in/local, not in CI |
