...
| `qa-e2e-reporter` | `.claude/agents/qa-e2e-reporter.md` | Runs the Playwright E2E suite against the running app, collects screenshots + video, and sends the artifacts to Slack (`scripts/notify-slack.ps1`); run/report only |
